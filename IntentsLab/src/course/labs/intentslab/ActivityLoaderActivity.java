...
public class ActivityLoaderActivity extends Activity {
	...
	public static final String ACTIVITY_EXPLICIT_RESULT_NAME = "EXPLICIT";
	...
	protected void onActivityResult(int requestCode, int resultCode, Intent data) {
	    ...
	    if (requestCode == GET_TEXT_REQUEST_CODE && resultCode == RESULT_OK) {
	    	...
	    	//Editable txt = (Editable)data.getExtras().get(ACTIVITY_EXPLICIT_RESULT_NAME);
	    	String txt = data.getStringExtra(ACTIVITY_EXPLICIT_RESULT_NAME);
	    	mUserTextView.setText(txt);
